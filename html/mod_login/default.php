			...
			<div class="controls">
				<?php if (!$params->get('usetext', 0)) : ?>
					<div class="input-prepend">
						<span class="add-on">
							<span class="icon-user hasTooltip" data-tooltip title="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME'); ?>"></span>
		...
		<div id="form-login-password" class="control-group">
			<div class="controls">
				<?php if (!$params->get('usetext', 0)) : ?>
					<div class="input-prepend">
						<span class="add-on">
							<span class="icon-lock hasTooltip" data-tooltip title="<?php echo JText::_('JGLOBAL_PASSWORD'); ?>">
							</span>
			...
			<div class="controls">
				<?php if (!$params->get('usetext', 0)) : ?>
					<div class="input-prepend input-append">
						<span class="add-on">
							<span class="icon-star hasTooltip" data-tooltip title="<?php echo JText::_('JGLOBAL_SECRETKEY'); ?>">
							</span>
						...
						<span class="btn width-auto hasTooltip" data-tooltip title="<?php echo JText::_('JGLOBAL_SECRETKEY_HELP'); ?>">
