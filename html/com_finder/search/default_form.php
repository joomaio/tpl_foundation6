			...
			<div class="input-group">	
				...
				<div class="input-group-button">
					...
					<?php if ($this->params->get('show_advanced', 1)) : ?>
						<button type="button" class="expand-des button secondary" id="query-explained" aria-label="<?php echo JText::_('COM_FINDER_ADVANCED_SEARCH_TOGGLE'); ?>">
							<?php echo JText::_('COM_FINDER_ADVANCED_SEARCH_TOGGLE'); ?></button>
					<?php endif; ?>
				</div>
			</div>
		</div>
	...
	<?php if ($this->params->get('show_advanced', 1)) : ?>
		<ul class="accordion" data-accordion data-allow-all-closed="true">
			<li class="accordion-item" data-accordion-item>
				<div class="accordion-content" data-tab-content data-remote="query-explained">
