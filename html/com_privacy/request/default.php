...
<div class="request-form<?php echo $this->pageclass_sfx; ?>">
	...
	<?php if ($this->sendMailEnabled) : ?>
		<form action="<?php echo JRoute::_('index.php?option=com_privacy&task=request.submit'); ?>" method="post" class="form-validate form-horizontal well" data-abide novalidate>
