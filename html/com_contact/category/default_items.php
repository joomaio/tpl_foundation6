	...
	<?php if ($this->params->get('filter_field') || $this->params->get('show_pagination_limit')) : ?>
		<div class="row">
			...
			<?php if ($this->params->get('show_pagination_limit')) : ?>
				<div class="column medium-6 large-3 large-offset-3">
			...
			<?php foreach ($this->items as $i => $item) : ?>
				<?php if (in_array($item->access, $this->user->getAuthorisedViewLevels())) : ?>
					<?php if ($this->items[$i]->published == 0) : ?>
						<div class="system-unpublished row stripes<?php echo $i % 2; ?>">
					<?php else : ?>
						<div class="row stripes<?php echo $i % 2; ?>" >
					<?php endif; ?>
					<?php if ($this->params->get('show_image_heading')) : ?>
						<?php $contactWidth = 7; ?>
						<div class="span2 column medium-2">
					...
					<?php else : ?>
						<?php $contactWidth = 9; ?>
					<?php endif; ?>
					<div class="list-title span<?php echo $contactWidth; ?> column medium-<?php echo $contactWidth; ?>">
						<a href="<?php echo JRoute::_(ContactHelperRoute::getContactRoute($item->slug, $item->catid)); ?>">
							<?php echo $item->name; ?>
						</a>
						<?php if ($this->items[$i]->published == 0) : ?>
					...
					<div class="span3 column medium-3">
