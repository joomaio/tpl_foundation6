...
<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm" class="margin-top-1 featured-contact">
	<div class="row">
		<?php if ($this->params->get('show_pagination_limit')) : ?>
			<div class="medium-6 large-3 large-offset-9 columns">
	...
	<div class="table-scroll">
		<table class="category hover">
			<?php if ($this->params->get('show_headings')) : ?>
			<thead><tr>
				<th class="item-num">
					<?php echo JText::_('JGLOBAL_NUM'); ?>
				</th>
				<th width="20%" class="item-title">
