...
<div class="profile-edit<?php echo $this->pageclass_sfx; ?>">
	...
	<form id="member-profile" action="<?php echo JRoute::_('index.php?option=com_users&task=profile.save'); ?>" method="post" class="form-validate form-horizontal well" enctype="multipart/form-data" data-abide novalidate>
			...
			<fieldset>
				...
				<div class="control-group">
					<div class="control-label">
						<label id="jform_twofactor_method-lbl" for="jform_twofactor_method" class="hasTooltip1" data-tooltip
		...
		<div class="grid-x grid-padding-x">
			...
			<div class="small-8 cell">
				<a class="button alert" href="<?php echo JRoute::_('index.php?option=com_users&view=profile'); ?>" title="<?php echo JText::_('JCANCEL'); ?>">
