...
<?php if (!empty($images->image_intro)) : ?>
	...
	<?php if ($params->get('link_titles') && $params->get('access-view')) : ?>
		<a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($displayData->slug, $displayData->catid, $displayData->language)); ?>"><img class="thumbnail" 
	...
	<?php else : ?><img class="thumbnail" 
		<?php if ($images->image_intro_caption) : ?>
			<?php echo ' title="' . htmlspecialchars($images->image_intro_caption, ENT_COMPAT, 'UTF-8') . '"'; ?>
		<?php endif; ?>
