	...
	<fieldset class="filters btn-toolbar clearfix">
		...
		<div class="row">
			<?php if ($this->params->get('filter_field') !== 'hide') : ?>
				<div class="medium-6 columns">
					<?php if ($this->params->get('filter_field') === 'tag') : ?>
						<label class="label" for="filter-month">
							<?php echo JText::_('TPL_FOUNDATION6_TAG_FILTER_LABEL') . '&#160;'; ?>
						</label>
					...
					<?php elseif ($this->params->get('filter_field') === 'month') : ?>
						<label class="label" for="filter-month">
							<?php echo JText::_('TPL_FOUNDATION6_MONTH_FILTER_LABEL') . '&#160;'; ?>
						</label>
			...
			<?php if ($this->params->get('show_pagination_limit')) : ?>
				<div class="small-6 medium-3 large-2 large-offset-10 columns">
...
<?php if (empty($this->items)) : ?>
	...
	<?php endif; ?>
<?php else : ?>
	<table class="category hover table-hover<?php echo $tableClass; ?>">
		<thead>
			<tr>
