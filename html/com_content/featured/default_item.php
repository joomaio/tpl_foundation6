...
<p><i class="fi-calendar"> <?php echo JHtml::_('date', $this->item->publish_up, 'd/m/Y'); ?></i>&nbsp;&nbsp;&nbsp;<i class="fi-comments"> <?php echo $this->item->event->afterDisplayContent; ?></i>&nbsp;&nbsp;&nbsp;<i class="fi-torso"> <?php echo JText::_('TPL_FOUNDATION6_AUTHOR_LABEL'); ?> <?php echo $this->item->author; ?></i></p>
